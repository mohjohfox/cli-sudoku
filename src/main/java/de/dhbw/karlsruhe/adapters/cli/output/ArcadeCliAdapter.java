...
public class ArcadeCliAdapter implements ArcadeOutputPort {
    ...
    public void introduction() {
        ...
        cliOutputPort.writeLine("Once upon a time, in a land filled with numbers and puzzles, there lived a small knight named Sir Mathalot.");
        cliOutputPort.writeLine("Sir Mathalot was known for his incredible math skills and bravery.");
        cliOutputPort.writeLine("One day, he embarked on a grand adventure through the Math Arcade to defeat the Math Monster and save the kingdom.");
    ...
    public void levelFive() {
        ...
        cliOutputPort.writeLine("After a long and challenging journey, Sir Mathalot finally reaches the Math Monster's Lair.");
        cliOutputPort.writeLine("To defeat the Math Monster and save the kingdom, he must face a series of math puzzles.");
        cliOutputPort.writeLine("The Math Monster's power lies in his knowledge of addition, subtraction, multiplication, and division.");
    ...
    public void levelSix() {
        ...
        cliOutputPort.writeLine("Here, he encounters fractions and must solve problems involving addition, subtraction, multiplication, and division of fractions.");
    ...
    public void levelSeven() {
        ...
        cliOutputPort.writeLine("To unlock the garden's hidden treasures, he must solve geometry problems and identify different shapes.");
    ...
    public void levelEight() {
        ...
        cliOutputPort.writeLine("He encounters time-related math problems, including calculating durations, reading clocks, and solving time word problems.");
    ...
    public void levelNine() {
        ...
        cliOutputPort.writeLine("Sir Mathalot finds himself in the depths of the Data Dungeon, a place filled with graphs, charts, and statistics.");
        cliOutputPort.writeLine("To uncover the dungeon's secrets, he must analyze data, interpret graphs, and solve data-related problems.");
    ...
    public void levelTen() {
        ...
        cliOutputPort.writeLine("He must solve a variety of math problems, including addition, subtraction, multiplication, division, fractions, geometry, time, and data.");
    ...
    public void levelEleven() {
        ...
        cliOutputPort.writeLine("To navigate through the market, he must solve money-related math problems, including counting coins, making change, and calculating total costs.");
        cliOutputPort.writeLine("Can you guide Sir Mathalot through the Money Market and help him master the world of money?");
    ...
    public void levelTwelve() {
        ...
        cliOutputPort.writeLine("To solve the puzzle, he must understand concepts like likelihood, chance, and probability calculations.");
    ...
    public void levelThirteen() {
        ...
        cliOutputPort.writeLine("He encounters various measurement tools and must solve problems involving length, weight, capacity, and temperature conversions.");
    ...
    public void levelFourteen() {
        ...
        cliOutputPort.writeLine("To overcome this challenge, he must simplify expressions, solve equations, and find unknown values.");
    ...
    public void levelFifteen() {
        ...
        cliOutputPort.writeLine("Sir Mathalot finds himself caught in a mysterious time warp, where time behaves strangely.");
        cliOutputPort.writeLine("To navigate through the time warp, he must solve time-related puzzles, including calculating durations, time zones, and solving time word problems.");
    ...
    public void levelSixteen() {
        ...
        cliOutputPort.writeLine("Sir Mathalot enters the Logic Labyrinth, a place filled with mind-bending logical puzzles.");
        cliOutputPort.writeLine("To navigate through the labyrinth, he must solve problems involving logical reasoning, patterns, and sequences.");
    ...
    public void levelSeventeen() {
        ...
        cliOutputPort.writeLine("He must solve geometry problems, identify shapes, calculate areas, perimeters, and angles.");
    ...
    public void levelEighteen() {
        ...
        cliOutputPort.writeLine("To conquer the fortress, he must solve problems involving fractions, including addition, subtraction, multiplication, and division.");
        cliOutputPort.writeLine("Can you guide Sir Mathalot through the Fractions Fortress and conquer the world of fractions?");
    ...
    public void levelNineteen() {
        ...
        cliOutputPort.writeLine("Sir Mathalot delves into the depths of the Data Dungeon, a place filled with data and statistics.");
        cliOutputPort.writeLine("To unlock the dungeon's secrets, he must analyze data, interpret graphs, and solve data-related problems.");
    ...
    public void levelTwenty() {
        ...
        cliOutputPort.writeLine("Sir Mathalot faces the final challenge, a test of all his math skills.");
        cliOutputPort.writeLine("He must solve a variety of math problems, including addition, subtraction, multiplication, division, fractions, geometry, time, data, logic, algebra, and more.");
        cliOutputPort.writeLine("Can you stand with Sir Mathalot and help him overcome this ultimate test?");
        cliOutputPort.writeLine("Prepare for the final showdown!");
    }
    ...
    public void conclusion() {
        ...
        cliOutputPort.writeLine("You have successfully completed all the levels of the Math Arcade game with Sir Mathalot.");
