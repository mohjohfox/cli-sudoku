...
import de.dhbw.karlsruhe.domain.models.arcade.MathProblemOperation;
...
public class MathProblemDialogService {
  ...
  private final MathProblemUsage mathProblemUsage = DependencyFactory.getInstance()
      .getDependency(MathProblemUsage.class);
  ...
  private final ArcadeOutputPort arcadeOutputPort = DependencyFactory.getInstance()
      .getDependency(ArcadeOutputPort.class);
